...
mobileApiRouter.post('/store-login', async (req: Request, res: Response) => {
  try {
...
mobileApiRouter.get('/document-types', async (req: Request, res: Response) => {
  try {
...
mobileApiRouter.get('/transactions/:storeId', async (req: Request, res: Response) => {
  try {
...
mobileApiRouter.post('/process-document', async (req: Request, res: Response) => {
  try {
